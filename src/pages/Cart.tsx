...
import {cartSelectorCount, cartSelectorItem, cartSelectorPrice, clearItems} from "../redux/slice/cartSlice";
import CartEmpty from "../components/CartEmpty";

const Cart = () => {
    const items: any = useSelector<any>(cartSelectorItem)
    const count: any = useSelector<any>(cartSelectorCount)
    const price: any = useSelector<any>(cartSelectorPrice)
            ...
            <div className="cart">
                ...
                <div className="cart__bottom">
                    <div className="cart__bottom-details">
                        ...
                        <span> Сумма заказа: <b>{price} ГРН</b> </span>
                    </div>
